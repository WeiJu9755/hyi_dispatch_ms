...
$list_view=<<<EOT
<div class="w-100 p-3">
	<table class="table table-bordered border-dark w-100" id="dispatch_material_details_table" style="min-width:1720px;">
		<thead class="table-light border-dark">
			<tr style="border-bottom: 1px solid #000;">
				...
				<th scope="col" class="text-center text-nowrap" style="width:6%;">處理</th>
			</tr>
		</thead>
		...
		$('#dispatch_material_details_table').dataTable( {
			...
			"fnRowCallback": function( nRow, aData, iDisplayIndex ) { 
				...
				if ('$disabled' == "disabled") {
					...
					var url1 = "openfancybox_edit('/index.php?ch=dispatch_material_details_modify&auto_seq="+aData[7]+"&fm=$fm',800,'96%','');";
					var mdel = "dispatch_material_details_myDel("+aData[7]+");";
...
var dispatch_material_details_myDel = function(auto_seq){
	xajax_dispatch_material_details_DeleteRow(auto_seq);
	return true;
};

var dispatch_material_details_myDraw = function(){
	var oTable;
	oTable = $('#dispatch_material_details_table').dataTable();
	oTable.fnDraw(false);
}
